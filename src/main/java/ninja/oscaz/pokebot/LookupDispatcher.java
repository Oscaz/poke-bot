...
public class LookupDispatcher {
    ...
    private final User user; // User of the query
    private final TextChannel channel;
    private final String query;

    public LookupDispatcher(User user, TextChannel channel, String query) {
        this.user = user;
    ...
    private void respond(LookupResult result) {
        ...
        searchResult.complete(this.user, this.channel, result); // Use the result's completion consumer to send user result messages
    }
